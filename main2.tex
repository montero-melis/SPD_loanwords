...
For the purposes of this project, we will adopt Thomason and Kaufman's (1988:37) definition of borrowings: "the incorporation of foreign features into a group's native language by speakers of that language", since it stresses the role of native speakers as agents in the process (see also Winford 2003:12).
...
Ok this is me adding another paragraph in order to push it to origin. This shit had better fucking work now.
