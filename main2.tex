...
Clearly the ``gap'' hypothesis of borrowing is insufficient to explain all items on the word lists. By scrutinizing the details of pairs of anglicisms / native alternatives this study will propose precise measurements for various denotational and connotational aspects of their respective meanings: denotational meaning loss/gain; dividing the semantic workload and the carving up of semantic space; ...
