...
%	\item  Any hypotheses about the borrowing of English grammatical markers? Like plural markings? Dutch has a native -s plural; perhaps Spanish -os and -as can be counted as such too. Does this entail differences in the ease of incorporation of English flection? (e.g. Swedish \emph{drinks} vs Dutch \emph{kids} -- which feels less strange because of the native plural).
